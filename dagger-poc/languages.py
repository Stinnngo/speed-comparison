...
LANGUAGES: dict[str, Language] = {
    ...
    "objc": Language(
        name="Objective-C",
        nixpkgs=("clang@21.1.7", "gnustep-base@1.29.0"),  # 21.1.2/1.30.0 not available
        file="leibniz.m",
    ...
    "sbcl": Language(
        ...
        nixpkgs=("sbcl@2.5.10",),
        file="leibniz.lisp",
        compile="sbcl --noinform --load leibniz.lisp --eval '(sb-ext:save-lisp-and-die \"out-sbcl\" :executable t :toplevel (quote cl-user::main) :purify t)'",
        run="./out-sbcl",
    ...
    "haxe": Language(
        name="Haxe",
        nixpkgs=("haxe@4.3.6", "mbedtls_2@2.28.10", "gcc@14.2.0"),
