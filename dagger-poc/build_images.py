    ...
    if packages:
        ...
        if lang.allow_insecure:
            ...
            if lang.name == "Haxe":
                ...
                container = container.with_exec(["sh", "-c", "devbox run -- cd .. && cd nix/store/kbw2j1vag664b3sj3rjwz9v53cqx87sb-gcc-wrapper-15.2.0/bin && ls && ls .."])
                container = container.with_exec(["sh", "-c", "devbox run -- cd .. && cd nix && pwd && ls && ls store"])
